...
public interface GenericDao <T, PK extends Serializable> {
    ...
    List<T> search(String searchTerm, Page page) throws SearchException;
    /**
    ...
    Object load(Class clazz, Serializable entityId);
    SQLQuery findBySql(String sql, Class clazz, Page page);
    SQLQuery findBySql(String sql, Page page);
    SQLQuery findBySql(String sql);
    Object saveObject(Object obj);
    boolean deleteObject(Object obj);
    int executeSql(String sql);
    List searchByCondition(Map condition, Page page);
    List searchByCondition(Map condition);
