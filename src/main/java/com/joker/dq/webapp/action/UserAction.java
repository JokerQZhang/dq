...
public class UserAction extends BaseAction implements Preparable {
    ...
    public String edit() throws IOException {
        ...
        String snakeId = request.getParameter("snakeid");
        if(snakeId!=null && !"".equals(snakeId)){
        	request.setAttribute("partyId", snakeId);
        	PartyUser partyUser = userManager.getUserId(snakeId);
        	if(partyUser!=null){
        		id = partyUser.getUserId().toString();
        	}
        }
    ...
    public String save() throws Exception {
        ...
        try {
        	if(isNew && (user.getEmail() == null || user.getEmail().equals(""))){
        		user.setEmail(user.getUsername() + "@aa.com");
        	}
            ...
            if(isNew){
            	...
            	if(partyId!=null && !"".equals(partyId)){
            		...
            		partyUser.setPartyId(Long.valueOf(partyId));
            		partyUser.setUserId(user.getId());
            		userManager.savePartyUser(partyUser);
            	}
            }
