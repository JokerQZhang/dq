...
@Entity
@Table(name="role_type",catalog="dq")
@Indexed
@XmlRootElement
public class RoleType extends BaseObject implements Serializable {
    ...
    @Id @GeneratedValue(strategy=IDENTITY) @DocumentId     @Column(name="role_type_id", unique=true, nullable=false)    
