...
@Entity
@Table(name="uom_type",catalog="dq")
@Indexed
@XmlRootElement
public class UomType extends BaseObject implements Serializable {
    ...
    @Id @GeneratedValue(strategy=IDENTITY) @DocumentId     @Column(name="uom_type_id", unique=true, nullable=false)    
