...
@Entity
@Table(name="party_user",catalog="dq")
@Indexed
@XmlRootElement
public class PartyUser extends BaseObject implements Serializable {
    ...
    @Id @GeneratedValue(strategy=IDENTITY) @DocumentId     @Column(name="party_user", unique=true, nullable=false)    
    ...
    public String toString() {
        ...
        sb.append(" [");
        sb.append("partyUser").append("='").append(getPartyUser()).append("', ");
