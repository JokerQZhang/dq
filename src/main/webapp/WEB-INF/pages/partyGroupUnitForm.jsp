...
<%@ page import="java.util.List,com.joker.dq.model.*" %>
        ...
        <div class="form-group">
            ...
            <c:if test="${not empty partyGroup.pgId}">
                <s:submit type="button" id="delete" cssClass="btn btn-danger" method="delete" key="button.delete"
                    onclick="$('#partyGroupForm').attr('action','/dqd/savePartyGroupUnit?delete=1'); return confirmMessage('确认删除？')" theme="simple">
