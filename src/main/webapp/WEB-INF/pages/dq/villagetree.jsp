	...
	<script type="text/javascript">
		...
		if(typeof(beforePartyGroupFormOpen) == "undefined"){
			beforePartyGroupFormOpen = function(data){
				if(selectedGroupId==null||selectedGroupId==""||isNowXiang==""){
		...
		function barLeafClick(spanItem, parentId, isXiang){
	        ...
	        if(parentId!=null && (isXiang=="xiang"||isXiang=="xian")){
...
%>
	<ul>
		<li>
			<span onclick="barLeafClick(this,'1','xian')"><i class="glyphicon glyphicon-th-list"></i> 尉氏县</span>
			<ul>
