...
<body>
	...
	<main class="main" role="main">
		<div class="container">
			<form class="form-horizontal" action="<c:url value="/dqd/examinationpaper"/>" method="post">
			  <div class="form-group">
			    <label for="answer_phone" class="col-sm-2 control-label">手机号</label>
			    <div class="col-sm-10">
			      <input type="phone" class="form-control" id="answer_phone" name="answer_phone" placeholder="手机号码">
			    </div>
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      <button type="submit" class="btn btn-default">开始考试</button>
			    </div>
			  </div>
			</form>
		</div>
