    ...
    <form method="post" action="${ctx}/dqd/zhibuTree" id="partyGroupSearchForm" class="form-inline" onsubmit="return ajaxSubmitFormUpdateAreas(this,$('#partyGroupSearchFormDiv'));">
	    ...
	    <div id="search" class="text-right">
	        ...
	        <div id="actions" class="btn-group">
		        ...
		        <a class="btn btn-primary btn-sm" href="#" onclick="ajaxLoadDaialog({url:'<c:url value='/dqd/editPartyGroupDangwei'/>',title:'党委支部信息',width:600,height:500,beforeDialogOpen:beforePartyGroupFormOpen,afterDialogOpen:afterPartyGroupFormOpen,data:{parentId:selectedGroupId,method:'Add',from:'list'}})" >
