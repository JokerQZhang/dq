...
afterSelectTbCarePeople = function(data){
	...
	ajaxUpdateArea("yflistDiv","<c:url value='/dqd/peopleYFTypes'/>",{selectedPeopleId:selectedPeopleId});
}
function addYFType(){
	...
	ajaxLoadDaialog({
		url:"<c:url value='/dqd/addPeopleYFType'/>",
...
function savePeopleYFType(){
	...
	$.ajax({
		url:"<c:url value='/dqd/savePeopleYFType'/>",
