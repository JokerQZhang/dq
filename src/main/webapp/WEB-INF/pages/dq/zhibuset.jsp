...
.tree li.parent_li>span:hover, .tree li.parent_li>span:hover+ul li span {
	...
	<div class="col-sm-7">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		    ...
		    <div id="dtlinfo">
		    	<jsp:include page="/WEB-INF/pages/dq/zhibuuser.jsp" flush="true"></jsp:include>
		    </div>
		  </div>
		</div>
	</div>
	...
	function addSysOper(){
		...
		ajaxLoadDaialog({url:'<c:url value='/dqd/editCunPerson'/>',title:'党委人员信息',width:600,height:500,beforeDialogOpen:undefined,afterDialogOpen:afterPartyGroupFormOpen,data:{belongGroupId:selectedGroupId,isNowXiang:"dangwei",method:'Add',from:'list'}});
	}
	</script>
