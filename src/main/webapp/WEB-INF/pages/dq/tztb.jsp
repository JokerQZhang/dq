...
<head>
	...
	<div class="col-sm-9">
		<div class="panel panel-default">
		  <div class="panel-heading">第一书记<span class="text-primary"><code id="zhibuname">(${currentPerson.name})</code></span>工作台帐填报：<strong><%=com.joker.dq.util.MyDateUtil.getCurrDate("yyyy-MM") %></strong></div>
