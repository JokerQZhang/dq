...
.tree li.parent_li>span:hover, .tree li.parent_li>span:hover+ul li span {
		...
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  	<div id="search" class="text-right">
				<div class="btn-group">
					<button class="btn btn-info btn-sm" onclick="addPositivePeople()">发展党员</button>
					<button class="btn btn-primary btn-sm" onclick="addPeople()">新增党员</button>
				</div>
			</div>
		    <!--<jsp:include page="/WEB-INF/pages/personList.jsp" flush="true"></jsp:include>-->
		    <div id="dtlinfo">
		    	<jsp:include page="/WEB-INF/pages/dq/zhibudtl.jsp" flush="true"></jsp:include>
		    </div>
		  </div>
		</div>
	</div>
	...
	function zhibuTreeSelect(partyId, isDangWei){
		...
		$.ajax({
			url:"<c:url value='/dqd/zhibuInfoDtl'/>"
			,type:"post"
