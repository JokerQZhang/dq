...
.tree li.parent_li>span:hover, .tree li.parent_li>span:hover+ul li span {
	...
	<div class="col-sm-7">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body" id="dtlpanel">
		  	<form method="post" action="<c:url value='/dqd/tzdtl'/>" id="tzdtlSearchForm" class="form-inline" onsubmit="return ajaxSubmitFormUpdateAreas(this,$('#dtlinfo'));">
	...
	function addPeople(){
		...
		ajaxLoadDaialog({url:'<c:url value='/dqd/editCunPerson'/>',title:'<fmt:message key="partyGroupDetail.heading"/>',width:600,height:500,beforeDialogOpen:undefined,afterDialogOpen:afterPartyGroupFormOpen,data:{belongGroupId:selectedGroupId,method:'Add',from:'list'}});
	}
