...
<div class="col-sm-7">
    ...
    <c:if test="${cookieLogin != 'true'}">
        ...
        <div class="row">
            <div class="col-sm-6">
                <s:hidden key="user.firstName" required="true" cssClass="form-control"/>
            </div>
            <div class="col-sm-6">
                <s:hidden key="user.lastName" required="true" cssClass="form-control"/>
            </div>
        </div>

        <div class="row">
            <div class="col-sm-6">
                <s:hidden key="user.email" required="true" cssClass="form-control"/>
            </div>
            <div class="col-sm-6">
                <s:hidden key="user.phoneNumber" cssClass="form-control"/>
            </div>
        </div>

        <s:hidden key="user.website" required="true" cssClass="form-control"/>
