...
<div class="col-sm-12">
	<s:form id="testQuestionForm" action="saveTestQuestion" method="post"
		...
		<div class="form-group col-sm-6">
			<label><fmt:message key="testQuestion.questionLevel" /></label> <input
				class="form-control" type="text" name="testQuestion.questionLevel"
				value="${testQuestion.questionLevel}" />
		</div>
		<div class="form-group col-sm-6">
			<label><fmt:message key="testQuestion.questionType" /></label> <input
				class="form-control" type="text" name="testQuestion.questionType"
				value="${testQuestion.questionType}" />
		</div>
		<div class="form-group col-sm-12">
			<label><fmt:message key="testQuestion.analysis" /></label> 
			<textarea class="form-control" name="testQuestion.analysis">${testQuestion.analysis}</textarea>
		</div>
