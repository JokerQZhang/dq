...
<div class="col-sm-12">
    <s:form id="petitionForm" action="saveFinishPetition" method="post" validate="false" cssClass="well" onsubmit="return ajaxSubmitFormUpdateAreas(this,undefined,afterSavePetition);">
...
%>
		...
		<div class="form-group col-sm-12">
       	  <label>结束备注</label>
       	  <textarea class="form-control" name="resolveresult" rows="5" cols="">${result}</textarea>
        </div>
