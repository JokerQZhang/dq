...
<header class="headers">
	...
	<nav class="headerNav">
        ...
        <a href="http://www.kfqicaihong.com/about-4.html" target="_blank">资质荣誉</a>
         -->
        <a href="http://www.kfqicaihong.com/about-11.html" target="_blank">联系方式</a>
        <a href="#" target="_blank">帮助</a>&nbsp;|&nbsp;<a class="last" href="http://www.kfqicaihong.com/Messagewrite.Asp" target="_blank">在线留言</a>
	</nav>
</header>
...
<footer id="footer" class="footers">
	<div class="footer-inner" id="footerInner">
		<a class="footerLogo" href="#" target="_blank" style="position: absolute"><img src="<c:url value='/images/bottomlog.png'/>" alt="尉氏县党群服务"></a>
